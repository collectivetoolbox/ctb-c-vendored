...
impl ActiveEventLoop {
    ...
    pub fn raw_display_handle_rwh_05(&self) -> rwh_05::RawDisplayHandle {
        ...
        display_handle.display = (&self.connection as *const Connection).cast_mut().cast();
    ...
    pub fn raw_display_handle_rwh_06(
        ...
        Ok(rwh_06::WaylandDisplayHandle::new(std::ptr::NonNull::from(&self.connection).cast())
            .into())
    }
}
                ...
                'outer: loop {
                    ...
                    *wait = PumpEventNotifierAction::Pause;
                    ...
                    while let Some(read_guard) = connection.prepare_read() {
                        ...
                        // Non-blocking read the connection; dispatch happens on the main queue.
